...
namespace Megatech.NAFSC.WPFApp
{
    ...
    public partial class PrintPreview : Window
    {
        ...
        private void PrintText()
        {
            try
            {
                ...
                if (textToPrint != null)
                {
                    ...
                    printFont = new Font("Calibri Light", 11);
        ...
        {
            ucPreview.SetDataSource(model, print_template);
            
            
            if (model.ChildInvoice != null)
            {
                ucPreview2.SetDataSource(model.ChildInvoice, print_template);
        ...
        {
            var window = new ImageCaptureWindow();
            window.ShowDialog();
        }
    }
}
